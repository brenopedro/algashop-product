...
public class QuantityInStockAdjustmentMongoDBImpl implements QuantityInStockAdjustment {
    ...
    private Result changeStockQuantity(UUID productId, int quantity, Query queryForUpdate) {
        ...
        if (productBeforeUpdate == null) throw new ProductNotFoundException(productId);
        ...
        Product productUpdated = mongoOperations.findAndModify(queryForUpdate, update, new FindAndModifyOptions()
